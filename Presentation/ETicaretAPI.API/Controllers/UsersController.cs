...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            GetAllUsersQueryReponse reponse = await _mediator.Send(getAllUsersQueryRequest);
        ...
        {
            GetRolesToUserQueryResponse reponse = await _mediator.Send(getRolesToUserQueryRequest);
