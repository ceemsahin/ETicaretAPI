...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<IActionResult> CompleteOrder([FromRoute]ComplateOrderCommandRequest completeOrderCommandRequest)
        {

            ComplateOrderCommandResponse response = await _mediator.Send(completeOrderCommandRequest);
