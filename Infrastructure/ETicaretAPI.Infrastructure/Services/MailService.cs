...
namespace ETicaretAPI.Infrastructure.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendMailAsync(string[] tos, string subject, string body, bool isBodyHtml = true)
        {
            ...
            mail.Body = body;
            mail.From = new("cmshn02@gmail.com", "CEMO CAN", System.Text.Encoding.UTF8);
        ...
        public async Task SendCompletedOrderMailAsync(string to,string orderCode, DateTime orderDate,string userName, string userSurname)
        {
            ...
            string mail =$"Sayın {userName} {userSurname} Merhaba <br>" +
                $"{orderDate} tarihinde vermiş olduğunuz {orderCode} kodlu siparişiniz tamamlanmış ve kargo firmasına verilmiştir. <br> Bizi tercih ettiğiniz için teşekkür ederim.";
