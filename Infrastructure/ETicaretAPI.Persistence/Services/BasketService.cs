...
namespace ETicaretAPI.Persistence.Services
{
    public class BasketService : IBasketService
    {
        ...
        public BasketService(IHttpContextAccessor httpContext, UserManager<AppUser> userManager, IOrderReadRepository orderReadRepository, IBasketItemWriteRepository basketItemWriteRepository, IBasketItemReadRepository basketItemReadRepository, IBasketWriteRepository basketWriteRepository, IBasketReadRepository basketReadRepository)
        {
        ...
        public async Task AddItemToBasketAsync(CreateBasketItemViewModel basketItem)
        {
            ...
            if (basket != null)
            {
                ...
                else await _basketItemWriteRepository.AddAsync(new()
                {
                    BasketId = basket.Id,
